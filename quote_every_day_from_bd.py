...
from other.long_poling import offset
...
async def main() -> None:
    ...
    scheduler.add_job(send_msg_if_not_plus, trigger="interval", hours=0, seconds=10, start_date=datetime.now(), kwargs={
        "bot": bot
        # "chat_id": -4161841389
    }, )
    ...
    # scheduler.add_job(send_msg_if_not_plus, trigger="cron", hour=13, minute=14, kwargs={
    #     "bot": bot}, timezone=timezone
    #                   , )
